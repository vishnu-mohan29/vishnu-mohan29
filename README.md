...
| **Project**      | **Description**                                                                                  |
|-------------------|--------------------------------------------------------------------------------------------------|
| **[Fast Food Nutrition Analytics (Power BI + SQL)](https://github.com/https://github.com/vishnu-mohan29/Fast-Food-Nutrition-Analytics)**    | "Power BI + SQL project analyzing fast food nutrition to identify unhealthy patterns and deliver data-driven dietary insights |
